...
function rollCharacter(){
    ...
    switch(temp){
        ...
        case 3:
        case 4:
            character.origin = "Trained (Gain two more specialties. Can trade a power for another two more specialties.)";
            break;
        case 5:
        case 6:
            character.origin = "Transformed (Increase one attribute or power of your choice by +2, to a maximum of 10)";
            break;
        case 7:
            character.origin = "Birthright (Gain either one additional power, or +2 to a power of your choice, to a maximum of 10)";
            break;
        case 8:
        case 9:
            character.origin = "Gimmick (Increase one mental attribute of your choice by +2, to a maximum of 10)";
            break;
        case 10:
            character.origin = "Artificial (Increase Strength by +2 and gain Life Support as a bonus power)";
            break;
        case 11:
        case 12:
            character.origin = "Unearthly (Increase two attributes or powers of your choice by +2, to a maximum of 10)";
            break;
    }
    ...
    for(i in character.attributes){
        ...
        if(i == 2 && character.origin.startsWith("Artificial")){
            character.attributes[i] += 2;
        }
    }
    ...
    for(i=0;i < character.powerCount;i++){
        ...
        switch(temp){
            case 2:
            case 3:
                character.powers.push(powerTable.Mental[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 4:
            case 5:
                character.powers.push(powerTable.Control[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 6:
                character.powers.push(powerTable.Defensive[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 7:
                character.powers.push(powerTable.Offensive[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 8:
                character.powers.push(powerTable.Movement[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 9:
            case 10:
                character.powers.push(powerTable.Alteration[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
            case 11:
            case 12:
                character.powers.push(powerTable.Sensory[roll1][rollB]+" "+roll2Adjusted().toString());
                break;
        }
        if(character.origin.startsWith("Artificial") && character.powers[i].startsWith("Life Support")){
            character.powers[i] == "Life Support 10";
            robotLifeSupport = true;
        }
    }
    if(character.origin.startsWith("Artificial") && !robotLifeSupport){
        character.powers.push("Life Support "+(adjustedScale(dice()+dice()).toString()));
        character.powerCount++;
    }
    ...
    if(character.origin.startsWith("Trained")){
        character.specialtyCount += 2;
    }
